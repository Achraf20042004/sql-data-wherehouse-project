...
select 
	...
	--ROW_NUMBER() est une fonction analytique (window function).
	--Elle attribue un numéro séquentiel unique à chaque ligne du résultat.
...
create view gold.dim_products as 
 select 
	 row_number() over (order by pn.prd_start_dt,pn.prd_key) as product_key,--we will be using it to connect our data model
